...
def get_para_asqp_targets(inputs, labels, dataset):
    """
...
def get_transformed_io(data_path, data_dir):
    ...
    targets = get_para_asqp_targets(texts, labels, data_dir)
