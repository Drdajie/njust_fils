...
def get_para_asqp_targets(sents, labels):
    ...
    for i, label in enumerate(labels):
        ...
        for holder, target, polarity, expression in label:
            ...
            NP1 = f"{target} is {polarity} because {holder} is {expression}."
            ...
            # 生成新的句子
            NP2 = f"{holder} is {polarity} because {target} is {random_expression}."
            ...
            # 生成新的句子
            NP3 = f"{holder} is {random_polarity} because {target} is {expression}."
